 ...
 * @author User
 */
public class Pahang extends States implements Region{
    
    public Pahang(String stateName, int carbonEmission, int levelAPI, int hazePercent) {
    ...
    public uiView[] getLightButtons(){
        ...
        uiView Haze1View = new uiView(smallLightHaze1, 230, 250, 150, 150, true);  
            
        Image smallLightHaze2 = new Image("Images/B1_2.PNG.png");
        uiView Haze2View = new uiView(smallLightHaze2, 330, 350, 150, 150, true);
        
        Image smallLightHaze3 = new Image("Images/B1_3.PNG.png");
        uiView Haze3View = new uiView(smallLightHaze3, 330,253, 150, 150, true);
        
        Image smallLightHaze4 = new Image("Images/B1_1.PNG.png");
        uiView Haze4View = new uiView(smallLightHaze4, 270, 280, 150, 150, true);
        
        Image smallLightHaze5 = new Image("Images/S1_2.PNG.png");
        uiView Haze5View = new uiView(smallLightHaze5, 430, 330, 200, 200, true);
