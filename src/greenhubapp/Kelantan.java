 ...
 * @author User
 */
public class Kelantan extends States implements Region{
    
    public Kelantan(String stateName, int carbonEmission, int levelAPI, int hazePercent) {
    ...
    public uiView[] getLightButtons(){
        ...
        uiView Haze1View = new uiView(smallLightHaze1, 280, 50, 130, 130, true);  
            
        Image smallLightHaze2 = new Image("Images/S1_4.PNG.png");
        uiView Haze2View = new uiView(smallLightHaze2, 280, 140, 130, 130, true);
        
        Image smallLightHaze3 = new Image("Images/S1_3.PNG.png");
        uiView Haze3View = new uiView(smallLightHaze3, 285, 120, 130, 130, true);
        
        Image smallLightHaze4 = new Image("Images/S1_2.PNG.png");
        uiView Haze4View = new uiView(smallLightHaze4, 270, 140, 130, 130, true);
    ...
    public uiView[] getMediumButtons(){
        Image smallLightHaze1 = new Image("SImages/2_5.PNG.png");
        uiView Haze1View = new uiView(smallLightHaze1, 280, 50, 130, 130, true);  
